...
def get_cashback_categories(
    ...
    """
    return cashback_service.get_cashback_categories(connection, meeting_uuid, participant_id)
...
def update_cashback_categories(
    ...
    """
    return cashback_service.update_cashback_categories(connection, meeting_uuid, participant_id, data)
...
def get_best_cashback(
    ...
    """
    return cashback_service.get_best_cashback(connection, meeting_uuid, category_id)
