...
export default function FourthSlide() {
    return (
        <div className="flex flex-col justify-start items-center text-center w-full h-full bg-[#EAE0CD] py-8 px-6 rounded-2xl">
            <div data-swiper-parallax="-200" className="mb-7">
                <h4 className="font-bold text-3xl text-[#463628]">FAQ</h4>
            </div>
            <div data-swiper-parallax="-100" className="w-full flex flex-col gap-2">
                <Accordion
